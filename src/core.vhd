...
architecture rtl of core is
	signal fetch_output: fetch_output_t := DEFAULT_FETCH_OUTPUT;
	signal decode_output: decode_output_t := DEFAULT_DECODE_OUTPUT;
	signal execute_output: execute_output_t := DEFAULT_EXECUTE_OUTPUT;
	signal memory_output: memory_output_t := DEFAULT_MEMORY_OUTPUT;
